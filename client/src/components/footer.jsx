        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" class="axr bkw">
                <span class="t text-sm">Facebook</span>
                <svg
                  fill="currentColor"
                  viewBox="0 0 55 24"
                  class="oc se"
              ...
              <a href="#" class="axr bkw">
                <span class="t text-sm">Instagram</span>
                <svg
                  fill="currentColor"
                  viewBox="0 0 55 24"
                  class="oc se"
              ...
              <a href="#" class="axr bkw">
                <span class="t text-sm">Twitter</span>
                <svg
                  fill="currentColor"
                  viewBox="0 0 35 24"
                  class="oc se"
              ...
              <a href="#" class="axp bkx">
                <span class="t text-sm">YouTube</span>
                <svg
                  fill="currentColor"
                  viewBox="0 0 40 24"
                  class="oc se"
